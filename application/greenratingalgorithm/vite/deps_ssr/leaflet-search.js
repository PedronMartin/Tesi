...
import {
  require_leaflet_src
} from "./chunk-2AQRN4JI.js";
import {
  __commonJS
} from "./chunk-6DU2HRTW.js";

// node_modules/leaflet-search/dist/leaflet-search.src.js
var require_leaflet_search_src = __commonJS({
  "node_modules/leaflet-search/dist/leaflet-search.src.js"(exports, module) {
    (function(factory) {
      ...
      L.Control.Search = L.Control.extend({
        ...
        _defaultFilterData: function(text, records) {
          ...
          icase = !this.options.casesensitive ? "i" : void 0;
        ...
        _recordsFromJsonp: function(text, callAfter) {
          ...
          var script = L.DomUtil.create("script", "leaflet-search-jsonp", document.getElementsByTagName("body")[0]), url = L.Util.template(this._getUrl(text) + "&" + this.options.jsonpParam + "=L.Control.Search.callJsonp", { s: text });
        ...
        _recordsFromAjax: function(text, callAfter) {
          ...
          var IE8or9 = L.Browser.ie && !window.atob && document.querySelector, request = IE8or9 ? new XDomainRequest() : new XMLHttpRequest(), url = L.Util.template(this._getUrl(text), { s: text });
        ...
        _searchInLayer: function(layer, retRecords, propName) {
          ...
          if (layer instanceof L.Marker || layer instanceof L.CircleMarker) {
            ...
            layer.eachLayer(function(layer2) {
              self._searchInLayer(layer2, retRecords, propName);
            });
          }
        },
...
export default require_leaflet_search_src();
